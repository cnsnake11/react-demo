	    ...
	    _createClass(Navigator1, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'page', id: 'bbt_nav_page_root' },
	                    this._getRootPage()
	                ),
	                _react2.default.createElement('div', { className: 'page', id: 'bbt_nav_page_1' }),
	                _react2.default.createElement('div', { className: 'page', id: 'bbt_nav_page_2' })
	            );
	        }
	    }, {
	        key: 'push',
