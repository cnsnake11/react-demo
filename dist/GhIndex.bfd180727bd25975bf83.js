	...
	var Navigator = function (_BaseComponent) {
	    ...
	    _createClass(Navigator, [{
	        ...
	        value: function push(route) {
	            ...
	            document.getElementById('bbt_nav_page_1').className = 'page';
	            document.getElementById('bbt_nav_page_0').className = 'page hidden';
	        }
	    }, {
	        key: 'pop',
	        value: function pop() {
	            this._routes.pop();
	            document.getElementById('bbt_nav_page_0').className = 'page';
	            document.getElementById('bbt_nav_page_1').className = 'page hidden';
	            _reactDom2.default.unmountComponentAtNode(document.getElementById('bbt_nav_page_1'));
	        }
	    }, {
	        key: '_getRootRoutePage',
	        value: function _getRootRoutePage() {
	            var page = this.getRootRoute().page;
	            return page();
	        }
	    }, {
	        key: 'getRootRoute',
