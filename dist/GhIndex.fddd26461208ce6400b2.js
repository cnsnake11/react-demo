	...
	var GhIndex = function (_BaseComponent) {
	    ...
	    _createClass(GhIndex, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(_Navigator2.default, { ref: 'nav', initialRoute: this._getInitRoute() });
	        }
	    }, {
	        key: '_getInitRoute',
	                ...
	                data.map(function (one) {
	                    return _react2.default.createElement(
	                        ...
	                        { onClick: function onClick() {
	                                ...
	                                _this3.getRefs().nav.push({
	                                    name: 'repos',
	                                    page: _react2.default.createElement(Repos, { a: _this3.getRoot() })
	                                });
	                            } },
	                        one.desc
	                    );
	    ...
	    _createClass(GhIndexObj, [{
	        ...
	        value: function init() {
	            ...
	            fetch('https://raw.githubusercontent.com/cnsnake11/helloapi/master/android_1').then(function (res) {
	                ...
	                alert(JSON.stringify(_this2.getState()));
	            });
	        }
	    }]);
	...
	var Navigator1 = function (_BaseComponent) {
	    ...
	    _createClass(Navigator1, [{
	        ...
	        value: function push(route) {
	            ...
	            _reactDom2.default.render(route.page, this.$('bbt_nav_page_1'));
	        ...
	        key: '_getRootPage',
	        value: function _getRootPage() {
	            return this._routes[0].page;
	        }
	    }, {
	        key: '_getCurPage',
	        value: function _getCurPage() {
	            return this._routes[this._routes.length - 1].page;
	        }
	    }, {
	        key: '_renderScene',
