...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="早教课堂" /><!-- 添加到主屏后的标题（iOS 6 新增） -->
    ...
    <?php StaticFileControl::add('/static/lg/dist/childclass/eeindex.css');?>
...
<?php StaticFileControl::add('/static/lg/dist/childclass/frame.js');  ?>
<?php StaticFileControl::add('/static/lg/dist/childclass/eeindex.js');  ?>
